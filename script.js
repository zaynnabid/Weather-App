...
async function checkweather(city) {
    ...
    var data = await response.json();  // response ko JS object ma change kr ke data nam k variable me store krta hn 
    ...
    // FIX: Changed 'assets/images/' to 'assets/' assuming icons are directly in the assets folder
...
document.getElementById("calendarForm").addEventListener("submit", async function (e) {
    ...
    // FIX: Changed 'modal' to 'calendarModal' to fix reference error
    calendarModal.hidden = true;
